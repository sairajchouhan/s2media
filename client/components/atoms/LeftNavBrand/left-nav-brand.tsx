...
export const LeftNavBrand = ({ onClick, ...props }: LeftNavBrandProps) => {
  return (
    <div
      {...props}
      onClick={onClick}
      className="inline-flex items-center px-8 my-6 text-2xl font-bold text-indigo-700 cursor-pointer group"
    >
      ...
      <div className="ml-2">
        S<span className="border-b-4 border-indigo-500">2</span>Media
      </div>
    </div>
  )
}
