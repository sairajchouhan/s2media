      ...
      <ul className="flex space-x-6">
        <li className="flex flex-col items-center space-y-1 ">
          <div className="relative p-0.5 rounded-full bg-gradient-to-tr from-indigo-400 to-pink-400">
            <a href="#" className="block p-0.5 bg-white rounded-full">
              <img className="w-16 h-16 rounded-full " src="https://placekitten.com/200/200" alt="" />
        ...
        <li className="flex flex-col items-center space-y-1 ">
          <div className="p-0.5 rounded-full bg-gradient-to-tr from-indigo-400 to-pink-400">
            <a href="#" className="block p-0.5 bg-white rounded-full">
              <img className="w-16 h-16 rounded-full " src="https://placekitten.com/201/200" alt="" />
            </a>
          </div>
          <a href="#" className="text-sm font-normal text-gray-600">
            cattie
        ...
        <li className="flex flex-col items-center space-y-1 ">
          <div className="p-0.5 rounded-full bg-gradient-to-tr from-indigo-400 to-pink-400">
            <a href="#" className="block p-0.5 bg-white rounded-full">
              <img className="w-16 h-16 rounded-full " src="https://placekitten.com/205/200" alt="" />
            </a>
          </div>
          <a href="#" className="text-sm font-normal text-gray-600">
            kitty
        ...
        <li className="flex flex-col items-center space-y-1 ">
          <div className="p-0.5 rounded-full bg-gradient-to-tr from-indigo-400 to-pink-400">
            <a href="#" className="block p-0.5 bg-white rounded-full">
              <img className="w-16 h-16 rounded-full " src="https://placekitten.com/203/200" alt="" />
            </a>
          </div>
          <a href="#" className="text-sm font-normal text-gray-600">
            akhil
